...
Clear-Host
Write-Host "`nPreparing environment... Please wait`n`n" -ForegroundColor Green
        ...
        <StackPanel HorizontalAlignment="Left" Grid.Column="0" Grid.Row="0" Margin="10,10,10,10" VerticalAlignment="Top" Grid.RowSpan="2">
            <GroupBox Header="Script and Pre-Requisites Info" HorizontalAlignment="Left" Margin="10,10,0,10" VerticalAlignment="Top" MinWidth="379">
                <Grid>
                    ...
                    <TextBlock Grid.Column="0" Grid.Row="3" Margin="5">Cloudistics PS Module:</TextBlock>
        ...
        <StackPanel Grid.Column="1" Grid.Row="1" Margin="10,0,10,10" HorizontalAlignment="Left">
            <GroupBox Header="How To Info:" HorizontalAlignment="Left" Margin="0,0,10,10" Width="350">
                <TextBlock TextWrapping="WrapWithOverflow">
                    All configuration files should be located in the 'Root Folder' (or, if desired so, in the Powershell Modules Folder for the Cloudistics PowerShell Module)
                    If the Module, configuration file and the E-mail Configuration file are not found, the option to create them becomes available.
                    Most fields should be automatically populated.
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUCihirQIRGdkdNg/TcidLSQU1
# EP2gggIDMIIB/zCCAWigAwIBAgIQZXsLzuTF+b1PPg61Cp25RzANBgkqhkiG9w0B
...
# NwIBFTAjBgkqhkiG9w0BCQQxFgQU2WQVIVHumYZ0cnHopui+mrCNu74wDQYJKoZI
# hvcNAQEBBQAEgYCKOe6IQV6WHZ43gcW+pV5/lnSTtk57rcCXd5HGKDR+jjAfVoN8
# 6wViCSYRIeddilh8oVjbwyffo9ai+j6Cc9yarHdv4CcHtiAKwIHOcBc1Zxk3Knot
# Zhnu/t8VoWoDuKGcDQkZUtRo3l/iif3RwFGxOmZFcMzj3gpQmQJSxR1Fgw==
